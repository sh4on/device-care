...
class AppStrings {
  ...
  static const String statusActiveSubtitle = 'Monitoring device input performance';
  static const String statusInactiveSubtitle = 'Tap to enable in Accessibility Settings';
